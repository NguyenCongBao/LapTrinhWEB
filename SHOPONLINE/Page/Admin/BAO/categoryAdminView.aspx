<%@ Page Title="" Language="C#" MasterPageFile="~/Page/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="categoryAdminView.aspx.cs" Inherits="SHOPONLINE.Page.Admin.BAO.categoryAdminView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="div1">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Height="226px" BorderStyle="Solid" BorderWidth="1px">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:BoundField DataField="CategoryID" HeaderText="ID Of Category" />
                    <asp:BoundField DataField="CategoryName" HeaderText="Name Of Categoroy" />
                    <asp:BoundField DataField="CategoryState" HeaderText="State Of Category" />
                </Columns>
    ...
    <div class="container2">
        <div style="width: 373px; float: left;padding-left:200px">
            <asp:Button ID="btthongke2" runat="server" Text="TK Category hết sản phẩm" Width="300px" OnClick="btthongke2_Click1" />
            <br />
            <asp:GridView ID="GridView3" runat="server" Width="371px" AutoGenerateColumns="False">
                <Columns>
                    <asp:BoundField DataField="CategoryID" HeaderText="ID Of Category" />
        ...
        <div style="width: 371px;float:left;padding-left:500px">
             <asp:Button ID="btthongke1" runat="server" Text="TK top3 Category có nhiều sản phẩm" Width="300px" OnClick="btthongke1_Click" />
            <br />
            <asp:GridView ID="GridView2" runat="server" Width="425px" AutoGenerateColumns="False">
                <Columns>
                    <asp:BoundField DataField="CategoryID" HeaderText="ID Of Category" >
