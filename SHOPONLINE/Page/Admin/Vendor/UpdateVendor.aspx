<%@ Page Title="" Language="C#" MasterPageFile="~/Page/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateVendor.aspx.cs" Inherits="SHOPONLINE.Page.Admin.Vendor.UpdateVendor" %>
            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                     <tr>
                        <th>ID</th>
                        <th>
                            <asp:TextBox ID="txtVendorID" runat="server" Enabled="false" CssClass="form-control"></asp:TextBox>
                        </th>
                    </tr>
                    <tr>
