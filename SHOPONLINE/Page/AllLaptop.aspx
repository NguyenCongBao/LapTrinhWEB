<%@ Page Title="" Language="C#" MasterPageFile="~/Page/Customer2.Master" AutoEventWireup="true" CodeBehind="AllLaptop.aspx.cs" Inherits="SHOPONLINE.Page.AllLaptop" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="auto-style2" style="font-size: 13px; font-weight: bold;">
                    ...
                    &nbsp;&gt;
                    <asp:HyperLink ID="HyperLink2" runat="server" Text="Laptop" NavigateUrl="~/Page/AllLaptop.aspx"></asp:HyperLink>
                    &nbsp;&gt;
                    <br />
                    <br />
                </div>
